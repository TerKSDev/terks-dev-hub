    ...
    {[...Array(5)].map((_, i) => (
      <div
        ...
        className={`h-1.5 w-1.5 rounded-full transition-colors duration-500 ${
          i < level ? "bg-stone-700" : "bg-transparent border border-stone-300"
        }`}
      ></div>
    ))}
  </div>
...
export default function Expertise() {
  return (
    <section
      id="expertise"
      className="relative flex w-full flex-col px-6 md:px-24 lg:px-36 py-16 min-h-[calc(100vh-68.8px)] overflow-hidden scroll-mt-17.25"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-y-12 z-10">
